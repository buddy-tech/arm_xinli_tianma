...
/* left channel */						/*	arm			pin */
#define GPIO_PIN_UD_L		(54)	/*	54			39	*/
#define GPIO_PIN_LR_L		(56)	/*	56			48	*/
#define GPIO_PIN_MODE_L		(60)	/*	60			38	*/
#define GPIO_PIN_STBY_L		(57)	/*	57			35	*/
#define GPIO_PIN_RST_L		(11)	/* 	11			47	*/
/* right channel */
#define GPIO_PIN_UD_R		(61)	/*	61			39	*/
#define GPIO_PIN_LR_R		(63)	/*	63			48	*/
#define GPIO_PIN_MODE_R		(72)	/*	72			38	*/
#define GPIO_PIN_STBY_R		(64)	/*	64			35	*/
#define GPIO_PIN_RST_R		(10)	/* 	10			47	*/

// TTL short test GPIO define.
/* left channel */
#define TTL_GPIO_PIN_UD_L		GPIO_PIN_UD_L
#define TTL_GPIO_PIN_LR_L		GPIO_PIN_LR_L
#define TTL_GPIO_PIN_MODE_L		GPIO_PIN_MODE_L
#define TTL_GPIO_PIN_STBY_L		GPIO_PIN_STBY_L
#define TTL_GPIO_PIN_RST_L		GPIO_PIN_RST_L
/* right channel */
#define TTL_GPIO_PIN_UD_R		GPIO_PIN_UD_R
#define TTL_GPIO_PIN_LR_R		GPIO_PIN_LR_R
#define TTL_GPIO_PIN_MODE_R		GPIO_PIN_MODE_R
#define TTL_GPIO_PIN_STBY_R		GPIO_PIN_STBY_R
#define TTL_GPIO_PIN_RST_R		GPIO_PIN_RST_R

// LVDS short test GPIO define.
/* left channel */
#define LVDS_GPIO_PIN_UD_L		GPIO_PIN_UD_L
#define LVDS_GPIO_PIN_LR_L		GPIO_PIN_LR_L
#define LVDS_GPIO_PIN_MODE_L	GPIO_PIN_MODE_L
#define LVDS_GPIO_PIN_STBY_L	GPIO_PIN_STBY_L
#define LVDS_GPIO_PIN_RST_L		GPIO_PIN_RST_L
/* right channel */
#define LVDS_GPIO_PIN_UD_R		GPIO_PIN_UD_R
#define LVDS_GPIO_PIN_LR_R		GPIO_PIN_LR_R
#define LVDS_GPIO_PIN_MODE_R	GPIO_PIN_MODE_R
#define LVDS_GPIO_PIN_STBY_R	GPIO_PIN_STBY_R
#define LVDS_GPIO_PIN_RST_R		GPIO_PIN_RST_R

/* define virtual spi control gpio */
#define LCM1_SPI_MOSI	(82)
#define LCM1_SPI_SCK	(83)
#define LCM1_SPI_CS		(84)
#define	LCM1_SPI_MISO	(85)
#define LCM1_SPI_MOSI_DIR	(93)

#define LCM2_SPI_MOSI	(86)
#define LCM2_SPI_SCK	(87)
#define LCM2_SPI_CS		(88)
#define	LCM2_SPI_MISO	(89)
#define LCM2_SPI_MOSI_DIR	(94)

/* define virtual i2c control gpio */
#define LCM1_I2C_SDA	(82)
#define LCM1_I2C_SCK	(83)
#define LCM1_I2C_SDA_DIR	(93)

#define LCM2_I2C_SDA	(86)
#define LCM2_I2C_SCK	(87)
#define LCM2_I2C_SDA_DIR	(94)

#define CHANNEL_ENABLE_GPIO_L	(70)
#define CHANNEL_ENABLE_GPIO_R	(58)

#define RST_2828_GPIO	(74)
#define RST_TTL_GPIO	RST_2828_GPIO
#define RST_LVDS_GPIO	RST_2828_GPIO

#define SUPPLY_POWER_2828_GPIO	(7)
#define K60_MASTER_SLAVE_POWER_EN_GPIO	(9)

#define MTP_CHANNEL_ENABLE_L	(14)
#define MTP_CHANNEL_ENABLE_R	(15)

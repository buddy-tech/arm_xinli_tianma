...
typedef enum CLIENT_MSG_E
{
	...
	CLIENT_MSG_NOTIFY    =   0x2023,	// Notify Message.
	...
	// Open/Short
	CLIENT_MSG_OPEN_SHORT_DEBUG = 0x204A,
	CLIENT_MSG_SET_OPEN_SHORT_MODE,
    CLIENT_MSG_READ_OPEN_SHORT_MODE,
	...
	// Power Test.
	// VCOM
    CLIENT_MSG_POWER_TEST_SET_VCOM_VOLT = 0x2060,
    CLIENT_MSG_POWER_TEST_ENABLE_VCOM_VOLT,
    CLIENT_MSG_POWER_TEST_READ_VCOM_VOLT,
    CLIENT_MSG_POWER_TEST_READ_VCOM_VOLT_STATUS,

	// OTP
	CLIENT_MSG_POWER_TEST_SET_OTP_VOLT,
    CLIENT_MSG_POWER_TEST_ENABLE_OTP_VOLT,
    CLIENT_MSG_POWER_TEST_READ_OTP_VOLT,
    CLIENT_MSG_POWER_TEST_READ_OTP_VOLT_STATUS,

	// Read Open/Short Data
	CLIENT_MSG_POWER_TEST_READ_OPEN_SHORT_DATA,

	// Read NTC/AG Data
	CLIENT_MSG_POWER_TEST_READ_NTC_AG_DATA,

	CLIENT_MSG_GPIO_GET_STATE,
	
	CLIENT_MSG_GENERAL_CMD = 0x2080,
}CLIENT_MSG_E;
...
typedef enum SERVER2CLI_MSG_E
{
	...
	// Open/Short
	SERVER2CLI_MSG_OPEN_SHORT_DEBUG = 0x404A,
	SERVER2CLI_MSG_SET_OPEN_SHORT_MODE,
    SERVER2CLI_MSG_READ_OPEN_SHORT_MODE,

	// Power Test.
	// VCOM
    SERVER2CLI_MSG_POWER_TEST_SET_VCOM_VOLT = 0x4060,
    SERVER2CLI_MSG_POWER_TEST_ENABLE_VCOM_VOLT,
    SERVER2CLI_MSG_POWER_TEST_READ_VCOM_VOLT,
    SERVER2CLI_MSG_POWER_TEST_READ_VCOM_VOLT_STATUS,

	// OTP
	SERVER2CLI_MSG_POWER_TEST_SET_OTP_VOLT,
    SERVER2CLI_MSG_POWER_TEST_ENABLE_OTP_VOLT,
    SERVER2CLI_MSG_POWER_TEST_READ_OTP_VOLT,
    SERVER2CLI_MSG_POWER_TEST_READ_OTP_VOLT_STATUS,

	// Read Open/Short Data
	SERVER2CLI_MSG_POWER_TEST_READ_OPEN_SHORT_DATA,

	// Read NTC/AG Data
	SERVER2CLI_MSG_POWER_TEST_READ_NTC_AG_DATA,

	// GPIO
	SERVER2CLI_MSG_GPIO_GET_STATE,

	SERVER2CLI_MSG_GENERAL_CMD = 0x4080,
